What is Andy X Bridge?
============

Buildersoft Andy X Bridge is an open source distrubuted system thats integrate different distributed streaming platforms together like Andy X, Pulsar and Kafka.
